...
import com.buzzware.callcabdriver.databinding.ActivityYourDestnationBinding
...
class YourDestnationActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(googelMaps: GoogleMap) {
        ...
        myGoogleMap?.addMarker(MarkerOptions().icon(setIcon(this, R.drawable.ic_pickup_pointer)).position(latLng))
